...
class CharacterEditorState extends MusicBeatState
{
	...
	var libraryInput:FlxUIInputText;
	...
	function addCharacterUI() {
		...
		libraryInput = new FlxUIInputText(imageInputText.x, imageInputText.y - 50, 200, 'exe', 8);
		var reloadImage:FlxButton = new FlxButton(imageInputText.x + 210, imageInputText.y - 3, "Reload Image", function()
		{
			char.imageFile = imageInputText.text;
			char.libraryPath = libraryInput.text;
			reloadCharacterImage();
		...
		tab_group.add(new FlxText(15, libraryInput.y - 18, 0, 'Library file name:'));
	...
	function reloadCharacterImage() {
		...
		if(Paths.fileExists('images/' + char.imageFile + '/Animation.json', TEXT)) {
			...
			char.frames = Paths.getSparrowAtlas(char.imageFile, char.libraryPath);
		}
